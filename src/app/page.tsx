      ...
      <div className={styles.wrapper}>
        ...
        <div className={styles.rightColumn}>
          <div className="mb-4">
            ...
            <p>その後、就職活動では裁量の大きさや職場環境を重視して株式会社CARTA HOLDINGSに入社。</p>
            <p>株式会社DIGITALIOに配属後は、不正対策を施したアフィリエイトシステムの構築や、外部ASPとの連携、外部のギフト発券サービスの組み込みなど、幅広いプロダクトを新卒時からリードしてきました。</p>
            <p>ポイントメディア事業を担当していた際は、チームリーダーとしてマネジメント業務を行いながら、プロジェクトマネージャーとしてプロジェクトを指揮し、プレイヤーとして実務もこなしておりました。</p>
